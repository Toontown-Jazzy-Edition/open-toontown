...
class ShtikerBook(DirectFrame, StateData.StateData):
    ...
    def load(self):
        ...
        self.resetFrameSize()
        self.bookOpenButton = DirectButton(parent=base.a2dBottomRight, image=(bookModel.find('**/BookIcon_CLSD'), bookModel.find('**/BookIcon_OPEN'), bookModel.find('**/BookIcon_RLVR')), relief=None, pos=(-0.158, 0, 0.17), scale=0.305, command=self.__open)
        self.bookCloseButton = DirectButton(parent=base.a2dBottomRight, image=(bookModel.find('**/BookIcon_OPEN'), bookModel.find('**/BookIcon_CLSD'), bookModel.find('**/BookIcon_RLVR2')), relief=None, pos=(-0.158, 0, 0.17), scale=0.305, command=self.__close)
